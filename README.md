...
1. saturation curve: To account for diminishing return of marketing activities. (- <img src="https://latex.codecogs.com/gif.latex?O_t=\text { Onset event at time bin } t " /> )
